...
export const aca34: Profile = {
  ...
  options: {
    ...
    "desktop-mcp": { tokens: { MECP_DEVICE_TOKEN: "mecp-device-token", ANTHROPIC_AUTH_TOKEN: "cornell-ai-gateway" }, baseUrl: "https://api.ai.it.cornell.edu" },   // same gateway as desktop-inference: decides the adopt path. ANTHROPIC_AUTH_TOKEN: cornell_secure_tools' x-litellm-api-key header in the bundle
